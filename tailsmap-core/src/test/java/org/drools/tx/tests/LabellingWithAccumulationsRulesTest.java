...
public class LabellingWithAccumulationsRulesTest {
    ...
    public static JavaArchive createDeployment() {
        ...
        JavaArchive jar = ShrinkWrap.create( JavaArchive.class )
                ...
                .addAsResource( "data/ret-loc.csv", "data/ret-loc.csv" )
...
//        }
        ...
        queryResults = kSession.getQueryResults( "getUnlocatedTXs", null );
        System.out.println( "Unlocated: " + queryResults.size() );
        iterator = queryResults.iterator();
        while ( iterator.hasNext() ) {
            QueryResultsRow next = iterator.next();
            Transaction tx = ( Transaction ) next.get( "$tx" );
            System.out.println( "Unlocated TX: with retailer ID" + tx.getRetailerId() );
        }
